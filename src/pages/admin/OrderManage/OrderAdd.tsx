...
import OrderActionCreator from "../../../redux/OrderActionCreator";

type PropsType = {
    addTodo: (todo: string, desc: string) => void;
};

const OrderAdd = ({ addTodo }: PropsType) => {
...
const mapDispatchToProps = (dispatch: Dispatch<AnyAction>) => ({
    addTodo: (todo: string, desc: string) => dispatch(OrderActionCreator.addTodo({ todo, desc })),
});

const AddTodoContainer = connect(null, mapDispatchToProps)(OrderAdd);
